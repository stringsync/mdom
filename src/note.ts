...
export class Note extends MElement {
  ...
  // The <clef> in effect for this note's staff: the nearest one at or before this
  // note, scanning back through the part. This single query is the whole
  ...
  // <key> in effect for this note's staff — same backward walk as clef().
  key(): Key | null {
  ...
  // <divisions> in effect (global, not per-staff) — needed to read <duration> as
  // beats. Same backward walk, proving it generalizes.
